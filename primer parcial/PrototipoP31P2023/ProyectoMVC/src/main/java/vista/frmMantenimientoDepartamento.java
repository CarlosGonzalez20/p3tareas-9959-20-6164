...
public class frmMantenimientoDepartamento extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        for (int i = 0; i < listaAulas.size(); i++) {
            dato[0] = listaAulas.get(i).getCodidoAula();
            dato[1] = listaAulas.get(i).getNombreAula();
            dato[2] = listaAulas.get(i).getEstatusAula();
            modelo.addRow(dato);
        }       
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(label1)
                        .addGap(294, 611, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        System.out.println("Usuario retornado:" + aula);        
        txtNombre.setText(aula.getNombreAula());
        txtEstatus.setText(aula.getEstatusAula());
