...
public class frmMantenimientoAplicaciones extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        clsAplicaciones aplicaciones = new clsAplicaciones();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsAplicaciones> listaAplicaciones = aplicaciones.getListadoAplicaciones();
        tablaAplicaciones.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaAplicaciones.size(); i++) {
            dato[0] = Integer.toString(listaAplicaciones.get(i).getIdAplicaciones());
            dato[1] = listaAplicaciones.get(i).getNombreAplicaciones();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        registrosBorrados=aplicacion.setBorrarAplicaciones(aplicacion);
